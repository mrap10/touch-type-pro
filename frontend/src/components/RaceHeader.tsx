    ...
    return (
        <div className="flex justify-between items-center mb-6 relative">
            <div className="flex flex-col sm:flex-row sm:gap-4">
                <h1 className="sm:text-2xl font-bold">Room: {roomId}</h1>
                    ...
                    <div className="flex flex-col md:flex-row items-center space-x-2">
                        <div className="flex flex-col sm:flex-row items-center gap-2">
                            <button
                                ...
                                className={`sm:px-4 w-full px-2 py-2 text-sm sm:text-base rounded-lg font-semibold flex items-center gap-2 mx-auto transition-colors cursor-pointer disabled:cursor-not-allowed disabled:opacity-60 ${startDisabled ? 'bg-gray-400 dark:bg-gray-600 text-white' : 'bg-emerald-500 hover:bg-emerald-600 text-white'}`}
                            >
                                <Play size={20} />
                                {startLabel}
                            </button>
            ...
            <button
                onClick={onLeaveRoom}
                className="bg-red-500 hover:bg-red-600 text-white px-4 py-2 text-sm md:text-base rounded-lg transition-colors cursor-pointer"
            >
                Leave Race
            </button>
        </div>
